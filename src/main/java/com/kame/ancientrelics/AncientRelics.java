...
public class AncientRelics {
	...
	public static CreativeTabs kame_random = new RelicTab(
			CreativeTabs.getNextID(), "Ancient Relics");
	...
	public static EnumArmorMaterial RelicM = EnumHelper.addArmorMaterial(
			"derpyniumam", 66, new int[] { 3, 7, 7, 3 }, 30);
	public static EnumToolMaterial RelicT = EnumHelper.addToolMaterial(
			"derpyniumtm", 3, 3500, 8.0F, 3.0F, 30);
	...
	public static Block RelicOre = new RelicOre(501, Material.iron).setTextureName("random:derpyniumOre").setCreativeTab(kame_random);
			
	public static Block RelicBlock = new RelicBlock(502, Material.iron).setTextureName("random:derpyniumBlock").setUnlocalizedName("RelicBlock").setCreativeTab(kame_random).setHardness(50.0F);
	...
	public void load(FMLInitializationEvent event) {
		...
		LanguageRegistry.addName(RelicSword, "Relic infused Sword");
		...
		GameRegistry.registerItem(RelicPickaxe, "RelicPickaxe");
		...
		LanguageRegistry.instance().addStringLocalization(
				"itemGroup.kame_random", "en_US", "Ancient Relics");
		...
		GameRegistry.addRecipe(wandcoreStack, "xyx", "yoy", "xyx", 'x',
				goldStack, 'y', stickStack, 'o', enderpearlStack);

		GameRegistry.addRecipe(relicFuelStack, " x ", "xyx", " x ", 'x',
				coalBlockStack, 'y', activatedRelicStack);

		GameRegistry.addRecipe(activatedRelicStack, " y ", "yxy", " y ", 'y',
				coalStack, 'x', InertRelicStack);

		GameRegistry.addRecipe(relicBlockStack, "xyx", "yxy", "yxy", 'y',
				InertRelicStack, 'x', stoneStack);

		GameRegistry.addRecipe(relichovelStack, " x ", " y ", 'x',
				activatedRelicStack, 'y', shovelStack);

		GameRegistry.addRecipe(relicswordStack, " x ", " y ", 'x',
				activatedRelicStack, 'y', swordStack);

		GameRegistry.addRecipe(relicaxeStack, " x ", " y ", 'x',
				activatedRelicStack, 'y', axeStack);

		GameRegistry.addRecipe(relicpickStack, " x ", " y ", 'x',
				activatedRelicStack, 'y', pickaxeStack);

		GameRegistry.addRecipe(relichoeStack, " x ", " y ", 'x',
				activatedRelicStack, 'y', hoeStack);

		GameRegistry.addRecipe(relicwand, " x ", " y ", 'x',
				activatedRelicStack, 'y', wandcoreStack);

		GameRegistry.addRecipe(relicHatStack, " x ", " y ", 'x',
				activatedRelicStack, 'y', ironhStack);

		GameRegistry.addRecipe(relicbootsStack, " x ", " y ", 'x',
				activatedRelicStack, 'y', ironbStack);

		GameRegistry.addRecipe(relicchestStack, " x ", " y ", 'x',
				activatedRelicStack, 'y', ironcStack);

		GameRegistry.addRecipe(reliclegsStack, " x ", " y ", 'x',
				activatedRelicStack, 'y', ironlStack);

		// FurnaceRecipes.smelting().addSmelting(Block.cloth.blockID, 15,
		// whiteWoolStack, 1.0f);O
	}
